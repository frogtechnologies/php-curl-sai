...
class SAI_CurlStub implements SAI_CurlInterface
{
    ...
    public static $infoLookup = array(
        ...
        CURLINFO_HTTP_CONNECTCODE => 'http_connectcode',
        CURLINFO_HTTPAUTH_AVAIL => 'httpauth_avail',
        CURLINFO_PROXYAUTH_AVAIL => 'proxyauth_avail',
        CURLINFO_OS_ERRNO => 'os_errno',
        CURLINFO_NUM_CONNECTS => 'num_connects',
        CURLINFO_SSL_ENGINES => 'ssl_engines',
        CURLINFO_COOKIELIST => 'cookielist',
        CURLINFO_FTP_ENTRY_PATH => 'ftp_entry_path',
        CURLINFO_APPCONNECT_TIME => 'appconnect_time',
        CURLINFO_CERTINFO => 'certinfo',
        CURLINFO_CONDITION_UNMET => 'condition_unmet',
        CURLINFO_RTSP_CLIENT_CSEQ => 'rtsp_client_cseq',
        CURLINFO_RTSP_CSEQ_RECV => 'rtsp_cseq_recv',
        CURLINFO_RTSP_SERVER_CSEQ => 'rtsp_server_cseq',
        CURLINFO_RTSP_SESSION_ID => 'rtsp_session_id',
        CURLINFO_CONTENT_LENGTH_DOWNLOAD_T => 'content_length_download_t',
        CURLINFO_CONTENT_LENGTH_UPLOAD_T => 'content_length_upload_t',
        CURLINFO_HTTP_VERSION => 'http_version',
        CURLINFO_PROTOCOL => 'protocol',
        CURLINFO_PROXY_SSL_VERIFYRESULT => 'proxy_ssl_verifyresult',
        CURLINFO_SCHEME => 'scheme',
        CURLINFO_SIZE_DOWNLOAD_T => 'size_download_t',
        CURLINFO_SIZE_UPLOAD_T => 'size_upload_t',
        CURLINFO_SPEED_DOWNLOAD_T => 'speed_download_t',
        CURLINFO_SPEED_UPLOAD_T => 'speed_upload_t',
        CURLINFO_APPCONNECT_TIME_T => 'appconnect_time_t',
        CURLINFO_CONNECT_TIME_T => 'connect_time_t',
        CURLINFO_FILETIME_T => 'filetime_t',
        CURLINFO_NAMELOOKUP_TIME_T => 'namelookup_time_t',
        CURLINFO_PRETRANSFER_TIME_T => 'pretransfer_time_t',
        CURLINFO_REDIRECT_TIME_T => 'redirect_time_t',
        CURLINFO_STARTTRANSFER_TIME_T => 'starttransfer_time_t',
        CURLINFO_TOTAL_TIME_T => 'total_time_t',
    );
}
